...
function AddContact() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const response = await axios.post('http://localhost:3000/api/contacts/create',{
    ...
    return (
        <>
            <div className="drawer w-[20%] drawer-end">
                ...
                <label htmlFor="my-drawer-4" className="drawer-button btn btn-primary">Add Contact</label>
                    ...
                    <div className=" menu min-h-full w-auto p-4 bg-[#1D232A] ">
                        <div className="join join-vertical w-screen lg:w-[700px] p-6">
                            ...
                            <div className="submit-btn  flex flex-row gap-6 justify-end">
                                ...
                                <button className=" btn btn-primary text-white font-bold py-2 px-4 rounded mt-5" onClick={handleSubmit}>Submit</button>
